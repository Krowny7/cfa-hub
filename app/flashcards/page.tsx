  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="rounded-2xl border p-4">
        ...
        <form className="mt-3 flex flex-wrap gap-2" action="/flashcards" method="get">
          <input
            name="q"
            defaultValue={q}
          ...
          {q || scope !== "all" ? (
            <Link href="/flashcards" className="rounded-lg border border-white/10 px-3 py-2 text-sm hover:bg-white/5">
              {L.reset}
            </Link>
          ) : null}
        </form>
