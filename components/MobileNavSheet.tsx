            ...
            <div className="mt-4 grid gap-2">
              {isAuthed ? (
                <>
                  ...
                  <Link href="/settings" className="btn btn-secondary justify-start" title={settingsLabel}>
                    <div className="flex w-full items-center gap-3">
                      ...
                      <span className="min-w-0 flex-1 truncate opacity-90">{userLabel ?? settingsLabel}</span>
                    </div>
                  </Link>
